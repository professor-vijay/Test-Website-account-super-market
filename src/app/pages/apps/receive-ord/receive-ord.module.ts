...
export class ReceiveModule {
    ...
    ItemDetail: [];
    // val: number;
    constructor(OrdId, billId, OrderedById, SuppliedById, receivedById, dispatchTypeId, finalarray,
        DispatchedDate, userId, createby, billAmountNoTax, billAmount, taxAmount, OrdDetail) {
